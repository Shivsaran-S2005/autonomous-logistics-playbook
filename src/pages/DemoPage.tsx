...
import { Map, Truck, Package, Activity, Brain, LayoutDashboard, AlertTriangle } from "lucide-react";
...
export default function DemoPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-background cyber-grid-bg flex flex-col">
      ...
      <div className="bg-neon-yellow/10 border-b border-accent/30 px-4 py-1.5 flex items-center justify-center gap-2">
        <AlertTriangle className="w-3.5 h-3.5 text-accent" />
        <span className="font-mono text-[10px] tracking-wider text-accent">
          SIMULATION ENVIRONMENT — NOT CONNECTED TO LIVE SYSTEMS
        </span>
      </div>
